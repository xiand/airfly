...
void OLED_Init(void)
{
	RCC_AHB1PeriphClockCmd(OLED_CS_RCC | OLED_RST_RCC | OLED_SCL_RCC | OLED_MOSI_RCC | OLED_RS_RCC, ENABLE); //使能时钟
	...
	gpio_Set(OLED_RS_PORT, OLED_RS_PIN);
	gpio_Set(OLED_RST_PORT, OLED_RST_PIN);
	gpio_Set(OLED_SCL_PORT, OLED_SCL_PIN);
	gpio_Set(OLED_MOSI_PORT, OLED_MOSI_PIN);
	OLED_MOSI_SET();
	OLED_SCL_SET();
